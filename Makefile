...
main : main.o  add.o  literal.o  sub.o  mul.o  div.o  great_operator.o  equle_operator.o  local_variable.o  bind_variable.o  variable_map.o

main.o : main.cpp  expression.hpp  literal.hpp  add.hpp  sub.hpp  mul.hpp  div.hpp  great_operator.hpp  equle_operator.hpp  variable.hpp  local_variable.hpp  bind_variable.hpp  variable_map.hpp
